...
public class VolunteerDashboardFrame extends JFrame {
    ...
    public VolunteerDashboardFrame() {
      ...
      // Donation Button
        ...
        JLabel imageLabel = new JLabel(new ImageIcon("C:\\Users\\yenus\\OneDrive\\Desktop\\VMS (1)\\VMS (1)\\VMS\\src\\resources\\images\\volunteerDashboard.jpg")); // Replace with actual image path
